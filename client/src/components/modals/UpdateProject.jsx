...
import {fetchTeams, updateProject} from "../../http/projectAPI";
import {observer} from "mobx-react-lite";
import {useParams} from "react-router-dom";

const UpdateProject = observer(({show, onHide}) => {
	...
	const updProject = async () => {
		let data;
		data = await updateProject(title, startDate, description, project.selectedTeam.id, id);
		onHide();
		setDescription('');
		setStartDate('');
		setTitle('');
